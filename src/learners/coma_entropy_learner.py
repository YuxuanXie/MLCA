...
class COMAEntropyLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        entropy = mac_out_entropy.view(-1)
        entropy_loss = (entropy * entropy_mask).sum() / entropy_mask.sum()
        ...
        total_loss = coma_loss - entropy_ratio * entropy_loss
        # Optimise agents
